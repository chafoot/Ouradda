...
Myself <a href=https://t.me/{}>{}</a>,\n\nTrust me ! I can't even imagine how super-fast i can drive your Database channel \n\nAre you ready for Long Drive Baby...🤪"""
    LZTHMB_TEXT = """Hello {},
Glad to see you here. It seems that you really love <a href=https://t.me/ouraddaa>Our Adda's</a> work.\n\n<b>Thumbnail extracting</b> feature will be available soon, please join <a href=https://t.me/ouraddaa_chat>Dev Channel</a> and stay tuned for next <a href=https://t.me/ouraddaa_chat>update</a>.\n\n  🐞 Report Bug here: <a href=https://t.me/ouraddaa_chat>Our Adda Support</a>
    """
    LZLINK_TEXT = """Hey {},
Glad to see you here. It seems that you really love <a href=https://t.me/ouraddaa >Our Adda's</a> work.\n\n<b>File to LiNK converting</b> feature will be available soon, please join <a href=https://t.me/ouraddaa_chat>Dev Channel</a> and stay tuned for next <a href=https://t.me/ouraddaa_chat>update</a>.\n\n  🐞 Report Bug here: <a href=https://t.me/ouraddaa_chat>Our Adda Support</a>
    """
    DNT_TEXT = """Hey sweetie {},
Thanks for thinking about us.\nIt seems that you really love <a href=https://t.me/ouraddaa >Our Adda's</a> work.\n\n<b>For your kind information, we do not ask or force anyone for any kind of payment</b>. But if you really want to donate us then you can send money to us from below links...\n\nT❤️ hank you so much..
    """
    REQ_AUTH_TEXT = """Hello {},
\nSorry sweetie.. You must have to be the Authentic User to complete this operation...\n\n👮‍♀ REPORT ISSUE HERE: <a href=https://t.me/ouraddaa_chat>Our Adda Support</a>\n\n
    """
    ...
    UPLOAD_START = "<b>initiating Our Adda Upload ⚡</b>"

    LAZY_UPLOAD_START = """<b>●❤♡ Recieving Our Adda File ♡❤●</b>\n\n⏯**File Name:** `{}`"""

    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "▼ Dᴏᴡɴʟᴏᴀᴅᴇᴅ ɪɴ {} sᴇᴄᴏɴᴅs.\n▲ Uᴘʟᴏᴀᴅᴇᴅ ɪɴ {} sᴇᴄᴏɴᴅs\n\n★.•☆•.★𑁔𑁔★ 𝖽𝖾𝗍✫𝗂𝗅𝗌 ★𑁔𑁔★.•☆•.★\n\n🔗<b>URL:</b> {}\n\n✩📂<b>F Name:</b> `{}`\n\n✩📝<b>C Name:</b> `{}`\n\n🧬**File Size:** `{}`\n\n🧡Thank you🧡"

    CUSTOM_CAPTION_UL_FILE = " "

    MELCOW_ENG = """Hᴇʟʟᴏ {} 😍, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ <b> {} </b> Gʀᴏᴜᴘ ❤️"""
...
"""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/ouraddaa>Our Adda</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
...
- Filter is the feature were users can set automated replies for a particular keyword and Our Adda will respond whenever that keyword hits the message
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/Ouradda)</code>
...
<b>NOTE:</b>
these are the extra features of Our Adda
