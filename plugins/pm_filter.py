...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("Hey sona, did you checked your spelling properly, here are some suggestions for you, please check if your requested content match anyone of these following suggestions... ♥️ ", reply_markup=InlineKeyboardMarkup(btn))
