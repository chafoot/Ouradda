...
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/caea863f92bed130cbe8c.gif")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Our Addaa™](https://t.me/ouradda)</b>⚡\n\n🎦 <b>File Name: </b> ➥  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Our Addaa™](https://t.me/ouraddaa)</b> ↭  🔥")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','ouraddaa') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+n-3mZ-8rPm4zMGVl") #[ without @ ]
